...
var file_user_proto_rawDesc = []byte{
	...
	0x36, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: pb.User.Hello:input_type -> pb.HelloRequest
	1, // 1: pb.User.Hello:output_type -> pb.HelloResponse
...
func (c *userClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.User/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
